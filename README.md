...
<img src=".github/assets/ErisPulseLogo.png" width="180" alt="ErisPulse WebhookAdapter" />

# ErisPulse WebhookAdapter

**Universal HTTP bridge adapter — connect any system to ErisPulse, low-code.**

A bidirectional bridge adapter for the ErisPulse framework. It ingests messages from any external system via HTTP and converts them into OneBot12 events, while forwarding messages emitted by ErisPulse modules to any target system — one account equals one inbound path plus one outbound URL.

<p>
  <a href="https://pypi.org/project/ErisPulse-WebhookAdapter/"><img src="https://img.shields.io/pypi/v/ErisPulse-WebhookAdapter?style=for-the-badge&logo=pypi&logoColor=white" alt="PyPI"></a>
  <a href="https://pypi.org/project/ErisPulse-WebhookAdapter/"><img src="https://img.shields.io/badge/Python-3.10+-FFD43B?style=for-the-badge&logo=python&logoColor=blue" alt="Python"></a>
  <a href="./LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue?style=for-the-badge" alt="License"></a>
  <a href="https://github.com/ErisPulse/ErisPulse-WebhookAdapter"><img src="https://img.shields.io/github/stars/ErisPulse/ErisPulse-WebhookAdapter?style=for-the-badge&logo=github&color=brightgreen" alt="Stars"></a>
  <a href="https://pepy.tech/project/ErisPulse-WebhookAdapter"><img src="https://img.shields.io/pepy/dt/ErisPulse-WebhookAdapter?style=for-the-badge&color=blue" alt="Downloads"></a>
